...
export interface TripUpdate_StopTimeUpdate_StopTimeProperties {
   ...
   * NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
   */
  dropOffType?: TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType | undefined;
}
...
export function tripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupTypeFromJSON(
  object: any,
): TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType {
  switch (object) {
    case 0:
    case "REGULAR":
      return TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType.REGULAR;
    case 1:
    case "NONE":
      return TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType.NONE;
    case 2:
    case "PHONE_AGENCY":
      return TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType.PHONE_AGENCY;
    case 3:
    case "COORDINATE_WITH_DRIVER":
      return TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType.COORDINATE_WITH_DRIVER;
    case -1:
    case "UNRECOGNIZED":
    default:
      return TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType.UNRECOGNIZED;
  }
}

export function tripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupTypeToJSON(
  object: TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType,
): string {
  switch (object) {
    ...
    case TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export enum TripDescriptor_ScheduleRelationship {
  ...
  SCHEDULED = 0,
  /**
   * ADDED - This value has been deprecated as the behavior was unspecified.
  ...
  CANCELED = 3,
  /**
   * REPLACEMENT - A trip that replaces an existing trip in the schedule.
   * NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
   */
  REPLACEMENT = 5,
  /**
  ...
  DELETED = 7,
  /**
   * NEW - An extra trip unrelated to any existing trips, for example, to respond to sudden passenger load.
   * NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
   */
  NEW = 8,
  UNRECOGNIZED = -1,
...
export function tripDescriptor_ScheduleRelationshipFromJSON(object: any): TripDescriptor_ScheduleRelationship {
  switch (object) {
    ...
    case 8:
    case "NEW":
      return TripDescriptor_ScheduleRelationship.NEW;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export const FeedMessage: MessageFns<FeedMessage> = {
  encode(message: FeedMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.header !== undefined) {
      FeedHeader.encode(message.header, writer.uint32(10).fork()).join();
    }
    for (const v of message.entity) {
      FeedEntity.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FeedMessage {
...
function createBaseFeedHeader(): FeedHeader {
  return { gtfsRealtimeVersion: "", incrementality: 0, timestamp: 0, feedVersion: "" };
}

export const FeedHeader: MessageFns<FeedHeader> = {
  encode(message: FeedHeader, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.feedVersion !== undefined && message.feedVersion !== "") {
      writer.uint32(34).string(message.feedVersion);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FeedHeader {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): FeedHeader {
    return {
      ...
      feedVersion: isSet(object.feedVersion) ? globalThis.String(object.feedVersion) : "",
    };
  },
  ...
  toJSON(message: FeedHeader): unknown {
    ...
    if (message.feedVersion !== undefined && message.feedVersion !== "") {
      obj.feedVersion = message.feedVersion;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<FeedHeader>, I>>(object: I): FeedHeader {
    ...
    message.feedVersion = object.feedVersion ?? "";
    return message;
  },
};
...
export const FeedEntity: MessageFns<FeedEntity> = {
  encode(message: FeedEntity, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
    ...
    if (message.tripUpdate !== undefined) {
      TripUpdate.encode(message.tripUpdate, writer.uint32(26).fork()).join();
    }
    if (message.vehicle !== undefined) {
      VehiclePosition.encode(message.vehicle, writer.uint32(34).fork()).join();
    }
    if (message.alert !== undefined) {
      Alert.encode(message.alert, writer.uint32(42).fork()).join();
    }
    if (message.shape !== undefined) {
      Shape.encode(message.shape, writer.uint32(50).fork()).join();
    }
    if (message.stop !== undefined) {
      Stop.encode(message.stop, writer.uint32(58).fork()).join();
    }
    if (message.tripModifications !== undefined) {
      TripModifications.encode(message.tripModifications, writer.uint32(66).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FeedEntity {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const TripUpdate: MessageFns<TripUpdate> = {
  encode(message: TripUpdate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.trip !== undefined) {
      TripDescriptor.encode(message.trip, writer.uint32(10).fork()).join();
    }
    if (message.vehicle !== undefined) {
      VehicleDescriptor.encode(message.vehicle, writer.uint32(26).fork()).join();
    }
    for (const v of message.stopTimeUpdate) {
      TripUpdate_StopTimeUpdate.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.timestamp !== undefined && message.timestamp !== 0) {
    ...
    if (message.tripProperties !== undefined) {
      TripUpdate_TripProperties.encode(message.tripProperties, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TripUpdate {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseTripUpdate_StopTimeEvent(): TripUpdate_StopTimeEvent {
  return { delay: 0, time: 0, uncertainty: 0, scheduledTime: 0 };
}

export const TripUpdate_StopTimeEvent: MessageFns<TripUpdate_StopTimeEvent> = {
  encode(message: TripUpdate_StopTimeEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.delay !== undefined && message.delay !== 0) {
    ...
    if (message.scheduledTime !== undefined && message.scheduledTime !== 0) {
      writer.uint32(32).int64(message.scheduledTime);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TripUpdate_StopTimeEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const TripUpdate_StopTimeUpdate: MessageFns<TripUpdate_StopTimeUpdate> = {
  encode(message: TripUpdate_StopTimeUpdate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.arrival !== undefined) {
      TripUpdate_StopTimeEvent.encode(message.arrival, writer.uint32(18).fork()).join();
    }
    if (message.departure !== undefined) {
      TripUpdate_StopTimeEvent.encode(message.departure, writer.uint32(26).fork()).join();
    }
    ...
    if (message.stopTimeProperties !== undefined) {
      TripUpdate_StopTimeUpdate_StopTimeProperties.encode(message.stopTimeProperties, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TripUpdate_StopTimeUpdate {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseTripUpdate_StopTimeUpdate_StopTimeProperties(): TripUpdate_StopTimeUpdate_StopTimeProperties {
  return { assignedStopId: "", stopHeadsign: "", pickupType: 0, dropOffType: 0 };
}

export const TripUpdate_StopTimeUpdate_StopTimeProperties: MessageFns<TripUpdate_StopTimeUpdate_StopTimeProperties> = {
  encode(
    message: TripUpdate_StopTimeUpdate_StopTimeProperties,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.assignedStopId !== undefined && message.assignedStopId !== "") {
      writer.uint32(10).string(message.assignedStopId);
    }
    if (message.stopHeadsign !== undefined && message.stopHeadsign !== "") {
      writer.uint32(18).string(message.stopHeadsign);
    }
    if (message.pickupType !== undefined && message.pickupType !== 0) {
      writer.uint32(24).int32(message.pickupType);
    }
    if (message.dropOffType !== undefined && message.dropOffType !== 0) {
      writer.uint32(32).int32(message.dropOffType);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TripUpdate_StopTimeUpdate_StopTimeProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): TripUpdate_StopTimeUpdate_StopTimeProperties {
    return {
      assignedStopId: isSet(object.assignedStopId) ? globalThis.String(object.assignedStopId) : "",
      stopHeadsign: isSet(object.stopHeadsign) ? globalThis.String(object.stopHeadsign) : "",
      pickupType: isSet(object.pickupType)
        ? tripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupTypeFromJSON(object.pickupType)
        : 0,
      dropOffType: isSet(object.dropOffType)
        ? tripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupTypeFromJSON(object.dropOffType)
        : 0,
    };
  },
  ...
  toJSON(message: TripUpdate_StopTimeUpdate_StopTimeProperties): unknown {
    ...
    if (message.pickupType !== undefined && message.pickupType !== 0) {
      obj.pickupType = tripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupTypeToJSON(message.pickupType);
    }
    if (message.dropOffType !== undefined && message.dropOffType !== 0) {
      obj.dropOffType = tripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupTypeToJSON(message.dropOffType);
    }
    return obj;
  },
...
function createBaseTripUpdate_TripProperties(): TripUpdate_TripProperties {
  return { tripId: "", startDate: "", startTime: "", shapeId: "", tripHeadsign: "", tripShortName: "" };
}

export const TripUpdate_TripProperties: MessageFns<TripUpdate_TripProperties> = {
  encode(message: TripUpdate_TripProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.tripHeadsign !== undefined && message.tripHeadsign !== "") {
      writer.uint32(42).string(message.tripHeadsign);
    }
    if (message.tripShortName !== undefined && message.tripShortName !== "") {
      writer.uint32(50).string(message.tripShortName);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TripUpdate_TripProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): TripUpdate_TripProperties {
    return {
      ...
      tripHeadsign: isSet(object.tripHeadsign) ? globalThis.String(object.tripHeadsign) : "",
...
export const VehiclePosition: MessageFns<VehiclePosition> = {
  encode(message: VehiclePosition, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.vehicle !== undefined) {
      VehicleDescriptor.encode(message.vehicle, writer.uint32(66).fork()).join();
    }
    ...
    for (const v of message.multiCarriageDetails) {
      VehiclePosition_CarriageDetails.encode(v!, writer.uint32(90).fork()).join();
    }
    return writer;
  },
...
export const VehiclePosition_CarriageDetails: MessageFns<VehiclePosition_CarriageDetails> = {
  encode(message: VehiclePosition_CarriageDetails, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VehiclePosition_CarriageDetails {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Alert: MessageFns<Alert> = {
  encode(message: Alert, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.informedEntity) {
      EntitySelector.encode(v!, writer.uint32(42).fork()).join();
    }
    ...
    if (message.url !== undefined) {
      TranslatedString.encode(message.url, writer.uint32(66).fork()).join();
    }
    if (message.headerText !== undefined) {
      TranslatedString.encode(message.headerText, writer.uint32(82).fork()).join();
    }
    if (message.descriptionText !== undefined) {
      TranslatedString.encode(message.descriptionText, writer.uint32(90).fork()).join();
    }
    if (message.ttsHeaderText !== undefined) {
      TranslatedString.encode(message.ttsHeaderText, writer.uint32(98).fork()).join();
    }
    if (message.ttsDescriptionText !== undefined) {
      TranslatedString.encode(message.ttsDescriptionText, writer.uint32(106).fork()).join();
    }
    if (message.severityLevel !== undefined && message.severityLevel !== 1) {
      writer.uint32(112).int32(message.severityLevel);
    }
    if (message.image !== undefined) {
      TranslatedImage.encode(message.image, writer.uint32(122).fork()).join();
    }
    if (message.imageAlternativeText !== undefined) {
      TranslatedString.encode(message.imageAlternativeText, writer.uint32(130).fork()).join();
    }
    if (message.causeDetail !== undefined) {
      TranslatedString.encode(message.causeDetail, writer.uint32(138).fork()).join();
    }
    if (message.effectDetail !== undefined) {
      TranslatedString.encode(message.effectDetail, writer.uint32(146).fork()).join();
    }
    return writer;
  },
...
export const TripDescriptor: MessageFns<TripDescriptor> = {
  encode(message: TripDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tripId !== undefined && message.tripId !== "") {
      writer.uint32(10).string(message.tripId);
    }
    ...
    if (message.modifiedTrip !== undefined) {
      TripDescriptor_ModifiedTripSelector.encode(message.modifiedTrip, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TripDescriptor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseTripDescriptor_ModifiedTripSelector(): TripDescriptor_ModifiedTripSelector {
  return { modificationsId: "", affectedTripId: "", startTime: "", startDate: "" };
}

export const TripDescriptor_ModifiedTripSelector: MessageFns<TripDescriptor_ModifiedTripSelector> = {
  encode(message: TripDescriptor_ModifiedTripSelector, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TripDescriptor_ModifiedTripSelector {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const VehicleDescriptor: MessageFns<VehicleDescriptor> = {
  encode(message: VehicleDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== undefined && message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.label !== undefined && message.label !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VehicleDescriptor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const EntitySelector: MessageFns<EntitySelector> = {
  encode(message: EntitySelector, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.trip !== undefined) {
      TripDescriptor.encode(message.trip, writer.uint32(34).fork()).join();
    }
    if (message.stopId !== undefined && message.stopId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EntitySelector {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const TranslatedString: MessageFns<TranslatedString> = {
  encode(message: TranslatedString, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.translation) {
      TranslatedString_Translation.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TranslatedString {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const TranslatedString_Translation: MessageFns<TranslatedString_Translation> = {
  encode(message: TranslatedString_Translation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.text !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TranslatedString_Translation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const TranslatedImage: MessageFns<TranslatedImage> = {
  encode(message: TranslatedImage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.localizedImage) {
      TranslatedImage_LocalizedImage.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TranslatedImage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const TranslatedImage_LocalizedImage: MessageFns<TranslatedImage_LocalizedImage> = {
  encode(message: TranslatedImage_LocalizedImage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TranslatedImage_LocalizedImage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Shape: MessageFns<Shape> = {
  encode(message: Shape, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.shapeId !== undefined && message.shapeId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Shape {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Stop: MessageFns<Stop> = {
  encode(message: Stop, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stopCode !== undefined) {
      TranslatedString.encode(message.stopCode, writer.uint32(18).fork()).join();
    }
    if (message.stopName !== undefined) {
      TranslatedString.encode(message.stopName, writer.uint32(26).fork()).join();
    }
    if (message.ttsStopName !== undefined) {
      TranslatedString.encode(message.ttsStopName, writer.uint32(34).fork()).join();
    }
    if (message.stopDesc !== undefined) {
      TranslatedString.encode(message.stopDesc, writer.uint32(42).fork()).join();
    }
    ...
    if (message.stopUrl !== undefined) {
      TranslatedString.encode(message.stopUrl, writer.uint32(74).fork()).join();
    }
    ...
    if (message.platformCode !== undefined) {
      TranslatedString.encode(message.platformCode, writer.uint32(122).fork()).join();
    }
    return writer;
  },
...
export const TripModifications: MessageFns<TripModifications> = {
  encode(message: TripModifications, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.selectedTrips) {
      TripModifications_SelectedTrips.encode(v!, writer.uint32(10).fork()).join();
    }
    ...
    for (const v of message.modifications) {
      TripModifications_Modification.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TripModifications {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const TripModifications_Modification: MessageFns<TripModifications_Modification> = {
  encode(message: TripModifications_Modification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.startStopSelector !== undefined) {
      StopSelector.encode(message.startStopSelector, writer.uint32(10).fork()).join();
    }
    if (message.endStopSelector !== undefined) {
      StopSelector.encode(message.endStopSelector, writer.uint32(18).fork()).join();
    }
    ...
    for (const v of message.replacementStops) {
      ReplacementStop.encode(v!, writer.uint32(34).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TripModifications_Modification {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const TripModifications_SelectedTrips: MessageFns<TripModifications_SelectedTrips> = {
  encode(message: TripModifications_SelectedTrips, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TripModifications_SelectedTrips {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const StopSelector: MessageFns<StopSelector> = {
  encode(message: StopSelector, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.stopSequence !== undefined && message.stopSequence !== 0) {
      writer.uint32(8).uint32(message.stopSequence);
    }
    if (message.stopId !== undefined && message.stopId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StopSelector {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ReplacementStop: MessageFns<ReplacementStop> = {
  encode(message: ReplacementStop, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ReplacementStop {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
